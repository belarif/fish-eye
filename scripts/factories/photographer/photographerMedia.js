...
function addButtonMedia(buttonMediaElt, figureMediaElt) {
  ...
  buttonMediaElt.setAttribute(
    "aria-label",
    "cliquez le bouton entrer pour ouvrir le média dans la modale"
  );
...
function photographerMediaFactory(media) {
  ...
  function getMediaCardDOM() {
    ...
    image
      ? setImgMedia(imgMediaElt, buttonMediaElt, picture, title)
      : setVideoMedia(videoMediaElt, buttonMediaElt, srcVideo);
